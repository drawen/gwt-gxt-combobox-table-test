  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.button.IconButtonDefaultAppearance.IconButtonStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GKNJ5M2OO{width:" + ("15px")  + ";height:" + ("15px")  + ";overflow:" + ("hidden")  + ";margin-right:" + ("2px")  + ";background-repeat:" + ("no-repeat")  + ";cursor:" + ("pointer")  + ";}")) : ((".GKNJ5M2OO{width:" + ("15px")  + ";height:" + ("15px")  + ";overflow:" + ("hidden")  + ";margin-left:" + ("2px")  + ";background-repeat:" + ("no-repeat")  + ";cursor:" + ("pointer")  + ";}"));
      }
