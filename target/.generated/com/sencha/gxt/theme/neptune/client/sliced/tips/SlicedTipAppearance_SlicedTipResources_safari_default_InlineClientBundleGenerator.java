...
public class SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipResources {
  private static SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator _instance0 = new SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GKNJ5M2NXD{padding:" + ("2px")  + ";font-size:" + ("12px")  + ";}.GKNJ5M2OXD{float:" + ("left")  + ";}.GKNJ5M2LXD{color:" + ("#444")  + ";font:" + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GKNJ5M2MXD{color:" + ("#444")  + ";font:" + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GKNJ5M2HXD{height:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GKNJ5M2JXD{height:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GKNJ5M2IXD{height:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat") ) + (";position:" + ("absolute")  + ";}.GKNJ5M2KXD{height:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GKNJ5M2LXD{color:" + (theme().tip().headerText().color() + "")  + ";font-size:" + (theme().tip().headerText().size() + "")  + ";font-weight:" + (theme().tip().headerText().weight() + "")  + ";font-family:" + (theme().tip().headerText().family() + "")  + ";padding:") + ((theme().tip().headerPadding().toString() + "")  + ";}.GKNJ5M2MXD{color:" + (theme().tip().messageText().color() + "")  + ";font-size:" + (theme().tip().messageText().size() + "")  + ";font-weight:" + (theme().tip().messageText().weight() + "")  + ";font-family:" + (theme().tip().messageText().family() + "")  + ";padding:" + (theme().tip().messagePadding().toString() + "")  + ";}")) : ((".GKNJ5M2NXD{padding:" + ("2px")  + ";font-size:" + ("12px")  + ";}.GKNJ5M2OXD{float:" + ("right")  + ";}.GKNJ5M2LXD{color:" + ("#444")  + ";font:" + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GKNJ5M2MXD{color:" + ("#444")  + ";font:" + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GKNJ5M2HXD{height:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GKNJ5M2JXD{height:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GKNJ5M2IXD{height:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat") ) + (";position:" + ("absolute")  + ";}.GKNJ5M2KXD{height:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipResources_safari_default_InlineClientBundleGenerator.this.anchorTop()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GKNJ5M2LXD{color:" + (theme().tip().headerText().color() + "")  + ";font-size:" + (theme().tip().headerText().size() + "")  + ";font-weight:" + (theme().tip().headerText().weight() + "")  + ";font-family:" + (theme().tip().headerText().family() + "")  + ";padding:") + ((theme().tip().headerPadding().toString() + "")  + ";}.GKNJ5M2MXD{color:" + (theme().tip().messageText().color() + "")  + ";font-size:" + (theme().tip().messageText().size() + "")  + ";font-weight:" + (theme().tip().messageText().weight() + "")  + ";font-family:" + (theme().tip().messageText().family() + "")  + ";padding:" + (theme().tip().messagePadding().toString() + "")  + ";}"));
      }
