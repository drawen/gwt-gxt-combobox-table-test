...
public class Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.neptune.client.base.field.Css3TriggerFieldAppearance.Css3TriggerFieldResources {
  private static Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator _instance0 = new Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator();
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.neptune.client.base.field.Css3TriggerFieldAppearance.Css3TriggerFieldStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? (("input.GKNJ5M2OJC,textarea.GKNJ5M2OJC{border-color:" + (theme().field().focusBorderColor() + "")  + ";}input.GKNJ5M2PJC,textarea.GKNJ5M2PJC{background-color:" + (theme().field().invalidBackgroundColor() + "")  + ";border:" + ("solid"+ " " +theme().field().invalidBorderColor() + "")  + ";border-width:" + (theme().field().invalidBorderWidth() + "px")  + ";height:" + (theme().field().height() + "px")  + ";line-height:" + (theme().field().height() + "px")  + ";}.GKNJ5M2FKC{position:" + ("relative")  + ";right:" + ("0")  + ";top:" + ("0")  + ";zoom:" + ("1")  + ";white-space:") + (("nowrap")  + ";text-align:" + ("right")  + ";}.GKNJ5M2MJC{color:" + (theme().field().text().color() + "")  + ";font-size:" + (theme().field().text().size() + "")  + ";font-family:" + (theme().field().text().family() + "")  + ";font-weight:" + (theme().field().text().weight() + "")  + ";border-color:" + (theme().field().borderColor() + "")  + ";border-radius:" + ("0")  + ";border-width:" + (theme().field().borderWidth() + "px")  + ";-webkit-box-sizing:" + ("border-box")  + ";-moz-box-sizing:" + ("border-box") ) + (";box-sizing:" + ("border-box")  + ";-webkit-box-shadow:" + ("none")  + ";box-shadow:" + ("none")  + ";border-style:" + ("solid")  + ";}.GKNJ5M2LJC{color:" + (theme().field().emptyTextColor() + "")  + ";}.GKNJ5M2DKC{height:" + ("auto")  + ";padding:" + (theme().field().padding().toString() + "")  + ";resize:" + ("none")  + ";height:" + (theme().field().height() + "px")  + ";line-height:" + (theme().field().height() + "px")  + ";vertical-align:") + (("top")  + ";}.GKNJ5M2JJC{padding:" + (theme().field().padding().toString() + "")  + ";resize:" + ("none")  + ";overflow:" + ("visible")  + ";}.GKNJ5M2BKC .GKNJ5M2EKC{height:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getHeight() + "px")  + ";width:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getSafeUri().asString() + "\") -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getLeft() + "px -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getTop() + "px  no-repeat")  + ";}.GKNJ5M2EKC{height:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getHeight() + "px")  + ";width:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getWidth() + "px")  + ";overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getSafeUri().asString() + "\") -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getLeft() + "px -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";top:" + ("50%")  + ";cursor:" + ("pointer")  + ";}.GKNJ5M2KJC .GKNJ5M2EKC{height:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getHeight() + "px")  + ";width:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getSafeUri().asString() + "\") -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getLeft() + "px -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getTop() + "px  no-repeat")  + ";}")) : (("input.GKNJ5M2OJC,textarea.GKNJ5M2OJC{border-color:" + (theme().field().focusBorderColor() + "")  + ";}input.GKNJ5M2PJC,textarea.GKNJ5M2PJC{background-color:" + (theme().field().invalidBackgroundColor() + "")  + ";border:" + ("solid"+ " " +theme().field().invalidBorderColor() + "")  + ";border-width:" + (theme().field().invalidBorderWidth() + "px")  + ";height:" + (theme().field().height() + "px")  + ";line-height:" + (theme().field().height() + "px")  + ";}.GKNJ5M2FKC{position:" + ("relative")  + ";left:" + ("0")  + ";top:" + ("0")  + ";zoom:" + ("1")  + ";white-space:") + (("nowrap")  + ";text-align:" + ("left")  + ";}.GKNJ5M2MJC{color:" + (theme().field().text().color() + "")  + ";font-size:" + (theme().field().text().size() + "")  + ";font-family:" + (theme().field().text().family() + "")  + ";font-weight:" + (theme().field().text().weight() + "")  + ";border-color:" + (theme().field().borderColor() + "")  + ";border-radius:" + ("0")  + ";border-width:" + (theme().field().borderWidth() + "px")  + ";-webkit-box-sizing:" + ("border-box")  + ";-moz-box-sizing:" + ("border-box") ) + (";box-sizing:" + ("border-box")  + ";-webkit-box-shadow:" + ("none")  + ";box-shadow:" + ("none")  + ";border-style:" + ("solid")  + ";}.GKNJ5M2LJC{color:" + (theme().field().emptyTextColor() + "")  + ";}.GKNJ5M2DKC{height:" + ("auto")  + ";padding:" + (theme().field().padding().toString() + "")  + ";resize:" + ("none")  + ";height:" + (theme().field().height() + "px")  + ";line-height:" + (theme().field().height() + "px")  + ";vertical-align:") + (("top")  + ";}.GKNJ5M2JJC{padding:" + (theme().field().padding().toString() + "")  + ";resize:" + ("none")  + ";overflow:" + ("visible")  + ";}.GKNJ5M2BKC .GKNJ5M2EKC{height:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getHeight() + "px")  + ";width:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getSafeUri().asString() + "\") -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getLeft() + "px -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowOver()).getTop() + "px  no-repeat")  + ";}.GKNJ5M2EKC{height:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getHeight() + "px")  + ";width:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getWidth() + "px")  + ";overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getSafeUri().asString() + "\") -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getLeft() + "px -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrow()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";top:" + ("50%")  + ";cursor:" + ("pointer")  + ";}.GKNJ5M2KJC .GKNJ5M2EKC{height:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getHeight() + "px")  + ";width:" + ((Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getSafeUri().asString() + "\") -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getLeft() + "px -" + (Css3TriggerFieldAppearance_Css3TriggerFieldResources_ie10_default_InlineClientBundleGenerator.this.triggerArrowClick()).getTop() + "px  no-repeat")  + ";}"));
      }
