...
public class SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources {
  private static SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator _instance0 = new SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.tips.TipDefaultAppearance.TipNestedDivFrameStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GKNJ5M2JJB{position:" + ("relative")  + ";outline:" + ("none")  + ";}.GKNJ5M2IJB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GKNJ5M2PJB{height:" + ((SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getTop() + "px  no-repeat")  + ";padding-right:" + (topLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GKNJ5M2OJB{height:" + ((SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topBorder()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topBorder()).getTop() + "px  repeat-x")  + ";width:" + ("auto")  + ";}.GKNJ5M2AKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topRightBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topRightBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topRightBorder()).getTop() + "px  repeat") ) + (";background-repeat:" + ("no-repeat")  + ";background-position:" + ("left"+ " " +"0")  + ";zoom:" + ("1")  + ";padding-left:" + (topRightBorder().getWidth() + "px")  + ";width:" + ("auto")  + ";}.GKNJ5M2GJB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomLeftBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomLeftBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomLeftBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";width:" + ("auto")  + ";background-position:" + ("0"+ " " +"bottom")  + ";padding-right:") + ((bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GKNJ5M2FJB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomBorder()).getTop() + "px  repeat")  + ";background-position:" + ("0"+ " " +"bottom")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";overflow:" + ("visible")  + ";height:" + (bottomBorder().getHeight() + "px") ) + (";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GKNJ5M2HJB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomRightBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomRightBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomRightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("left"+ " " +"bottom")  + ";padding-left:" + (bottomRightBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";line-height:") + (("1px")  + ";font-size:" + ("1px")  + ";}.GKNJ5M2KJB{width:" + ((SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.leftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.leftBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.leftBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.leftBorder()).getTop() + "px  repeat-y")  + ";padding-right:" + (bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GKNJ5M2NJB{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.rightBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.rightBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.rightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("repeat-y")  + ";background-position:" + ("left"+ " " +"0")  + ";padding-left:" + (rightBorder().getWidth() + "px")  + ";overflow:" + ("visible")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GKNJ5M2IJB{height:" + ("100%")  + ";}")) : ((".GKNJ5M2JJB{position:" + ("relative")  + ";outline:" + ("none")  + ";}.GKNJ5M2IJB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GKNJ5M2PJB{height:" + ((SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getHeight() + "px")  + ";width:" + ((SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topLeftBorder()).getTop() + "px  no-repeat")  + ";padding-left:" + (topLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GKNJ5M2OJB{height:" + ((SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topBorder()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topBorder()).getTop() + "px  repeat-x")  + ";width:" + ("auto")  + ";}.GKNJ5M2AKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topRightBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topRightBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.topRightBorder()).getTop() + "px  repeat") ) + (";background-repeat:" + ("no-repeat")  + ";background-position:" + ("right"+ " " +"0")  + ";zoom:" + ("1")  + ";padding-right:" + (topRightBorder().getWidth() + "px")  + ";width:" + ("auto")  + ";}.GKNJ5M2GJB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomLeftBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomLeftBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomLeftBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";width:" + ("auto")  + ";background-position:" + ("0"+ " " +"bottom")  + ";padding-left:") + ((bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GKNJ5M2FJB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomBorder()).getTop() + "px  repeat")  + ";background-position:" + ("0"+ " " +"bottom")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";overflow:" + ("visible")  + ";height:" + (bottomBorder().getHeight() + "px") ) + (";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GKNJ5M2HJB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomRightBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomRightBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.bottomRightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("right"+ " " +"bottom")  + ";padding-right:" + (bottomRightBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";line-height:") + (("1px")  + ";font-size:" + ("1px")  + ";}.GKNJ5M2KJB{width:" + ((SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.leftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.leftBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.leftBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.leftBorder()).getTop() + "px  repeat-y")  + ";padding-left:" + (bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GKNJ5M2NJB{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.rightBorder()).getSafeUri().asString() + "\") -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.rightBorder()).getLeft() + "px -" + (SlicedTipAppearance_SlicedTipDivFrameResources_default_InlineClientBundleGenerator.this.rightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("repeat-y")  + ";background-position:" + ("right"+ " " +"0")  + ";padding-right:" + (rightBorder().getWidth() + "px")  + ";overflow:" + ("visible")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GKNJ5M2IJB{height:" + ("100%")  + ";}"));
      }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'background': return this.@com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources::background()();
      case 'bottomBorder': return this.@com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources::bottomBorder()();
      case 'bottomLeftBorder': return this.@com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources::bottomLeftBorder()();
      case 'bottomRightBorder': return this.@com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources::bottomRightBorder()();
      case 'leftBorder': return this.@com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources::leftBorder()();
      case 'rightBorder': return this.@com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources::rightBorder()();
      case 'topBorder': return this.@com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources::topBorder()();
      case 'topLeftBorder': return this.@com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources::topLeftBorder()();
      case 'topRightBorder': return this.@com.sencha.gxt.theme.neptune.client.sliced.tips.SlicedTipAppearance.SlicedTipDivFrameResources::topRightBorder()();
