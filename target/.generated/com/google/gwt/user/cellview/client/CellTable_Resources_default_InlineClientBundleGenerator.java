  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GKNJ5M2ED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GKNJ5M2FD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GKNJ5M2OC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GKNJ5M2DE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GKNJ5M2DE:hover{color:" + ("#6c6b6b")  + ";}.GKNJ5M2PC{background:" + ("#fff")  + ";}.GKNJ5M2AD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GKNJ5M2PD{background:" + ("#f3f7fb")  + ";}.GKNJ5M2AE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GKNJ5M2GD{background:" + ("#eee")  + ";}.GKNJ5M2HD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GKNJ5M2JD{background:" + ("#ffc")  + ";}.GKNJ5M2KD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GKNJ5M2BE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GKNJ5M2CE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GKNJ5M2ID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GKNJ5M2OD{margin:") + (("30px")  + ";}")) : ((".GKNJ5M2ED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GKNJ5M2FD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GKNJ5M2OC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GKNJ5M2DE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GKNJ5M2DE:hover{color:" + ("#6c6b6b")  + ";}.GKNJ5M2PC{background:" + ("#fff")  + ";}.GKNJ5M2AD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GKNJ5M2PD{background:" + ("#f3f7fb")  + ";}.GKNJ5M2AE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GKNJ5M2GD{background:" + ("#eee")  + ";}.GKNJ5M2HD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GKNJ5M2JD{background:" + ("#ffc")  + ";}.GKNJ5M2KD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GKNJ5M2BE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GKNJ5M2CE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GKNJ5M2ID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GKNJ5M2OD{margin:") + (("30px")  + ";}"));
      }
